...
void FDeferredShadingSceneRenderer::Render(FRHICommandListImmediate& RHICmdList)
{
	...
	if (ViewFamily.bResolveScene)
	{
		...
		PostProcessingInputs.SceneColor = GraphBuilder.RegisterExternalTexture(SceneContext.GetSceneColor(), TEXT("SceneColor")); // 这个texture在后处理的过程中被修改
